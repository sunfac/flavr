...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center text-center px-4 relative z-10 pt-20">
        ...
        >
          ...
          <div className="relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
            {/* Subtle ambient glow */}
            <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/20 via-white/10 to-orange-500/20 rounded-3xl blur-xl opacity-60"></div>
            <div className="absolute -inset-2 bg-gradient-to-r from-orange-400/10 via-white/5 to-orange-400/10 rounded-3xl blur-2xl opacity-40"></div>
            ...
            <div className="relative z-10">
              ...
              <motion.div
                ...
                className="absolute top-4 right-4 w-2 h-2 bg-orange-400 rounded-full opacity-60 animate-pulse"
              ></motion.div>
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 1, delay: 1.2 }}
                className="absolute bottom-6 left-6 w-1 h-1 bg-white rounded-full opacity-40 animate-pulse"
              ></motion.div>
            </div>
          </div>
        </motion.div>
      ...
      {/* Flavr+ CTA Section - Apple-Inspired */}
      <section id="pricing" className="py-24 px-4 relative z-10 overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-amber-400/10 rounded-full blur-2xl"></div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-orange-500/20 via-orange-600/15 to-red-500/20 backdrop-blur-2xl border border-orange-300/20 rounded-3xl p-10 md:p-16 text-center shadow-2xl">
              {/* Multi-layer glow effect */}
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/40 via-amber-500/30 to-red-500/40 rounded-3xl blur-xl opacity-80"></div>
              <div className="absolute -inset-2 bg-gradient-to-r from-orange-400/20 via-amber-400/15 to-red-400/20 rounded-3xl blur-2xl opacity-60"></div>
              ...
              <div className="relative z-10">
                ...
                >
                  <div className="relative">
                    ...
                    <img src={FlavrLogo} alt="Flavr+" className="relative w-16 h-16 mr-4" />
                  </div>
                ...
                <motion.p 
                  ...
                  whileInView={{ opacity: 1 }}
                  transition={{ duration: 0.8, delay: 0.6 }}
                  className="text-lg md:text-xl text-orange-50 font-light mb-10 max-w-3xl mx-auto leading-relaxed"
                >
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="absolute -inset-1 bg-gradient-to-r from-white/30 to-yellow-200/30 rounded-full blur-lg opacity-70"></div>
                  
                  <Button 
                    className="relative px-10 py-5 md:px-12 md:py-6 text-lg md:text-xl font-bold bg-white text-orange-600 hover:bg-orange-50 shadow-2xl hover:shadow-white/30 hover:scale-105 transition-all duration-500 rounded-full backdrop-blur-sm group"
                  >
                    <span className="flex items-center">
                      Upgrade to Flavr+ 
                      <Star className="ml-3 w-5 h-5 fill-current group-hover:rotate-12 transition-transform duration-300" />
                    </span>
                  </Button>
                </motion.div>
                
                {/* Floating elements */}
                <div className="absolute top-6 right-6 w-2 h-2 bg-yellow-300 rounded-full opacity-70 animate-pulse"></div>
      ...
      <footer className="py-16 px-4 border-t border-white/10 relative z-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-12"
          >
            {/* Subtle glow */}
            <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/10 via-white/5 to-orange-500/10 rounded-3xl blur-xl opacity-50"></div>
