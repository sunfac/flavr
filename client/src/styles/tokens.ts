...
export const typography = {
  // Modular scale for fluid typography
  stepMinus1: 'clamp(0.825rem, 0.80rem + 0.20vw, 0.90rem)',
  step0: 'clamp(1.00rem, 0.98rem + 0.25vw, 1.10rem)',
  step1: 'clamp(1.25rem, 1.20rem + 0.35vw, 1.40rem)',
  step2: 'clamp(1.56rem, 1.50rem + 0.45vw, 1.75rem)',
  step3: 'clamp(1.95rem, 1.90rem + 0.55vw, 2.15rem)',
};
