// Simple inline SVG icons to eliminate build dependencies
// This replaces Lucide React to solve production build timeouts
...
export const MessageCircleIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
