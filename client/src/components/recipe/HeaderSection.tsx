    ...
    <div className="relative">
      ...
      <div className="relative w-full">
        ...
        {currentImage && !recipe.imageLoading ? (
          <div className="relative w-full aspect-[16/10] sm:aspect-[4/3] lg:aspect-[3/2] bg-gradient-to-br from-orange-400 to-orange-600 rounded-t-xl overflow-hidden">
            <img 
              src={currentImage} 
              alt={recipe.title}
          ...
          <div className="relative w-full aspect-[16/10] sm:aspect-[4/3] lg:aspect-[3/2] bg-gradient-to-br from-orange-400 to-orange-600 rounded-t-xl overflow-hidden flex items-center justify-center">
