...
✅ FAVOR MEAT RECIPES: Unless the user specifies vegetarian, vegan, or fish preferences, generate meal plans with 80% meat-based dishes featuring chicken, beef, lamb, pork as primary proteins.
