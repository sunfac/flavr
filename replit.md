...
- June 25, 2025. Imagen 3 integration complete - replaced Replicate image generation with Google's Imagen 3 API for higher quality recipe images, added proper Google Cloud authentication and project configuration
