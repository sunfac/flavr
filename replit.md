...
- January 25, 2025. Protein weighting system optimized for UK preferences - enhanced protein arrays across all cooking modes to prioritize widely-used proteins (chicken breast/thighs, lamb chops/shoulder/leg, king prawns, cod fillet/loins, beef mince/steaks/joints, pork tenderloin/chops/belly, sea bass, salmon fillet, halloumi, sea bream, haddock) with higher frequency weighting, reduced frequency of premium proteins like venison and game birds while maintaining availability, improved seed-based protein selection to better reflect UK consumer purchasing patterns and cooking preferences
```
